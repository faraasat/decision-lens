        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="glass-panel rounded-2xl p-1">
            <div className="flex border-b border-blue-900/50">
              {['macro', 'micro', 'efficiency', 'what-if'].map((tab) => (
                <button
                  key={tab}
                ...
                >
                  {tab === 'efficiency' ? 'Player Stats' : `${tab} Review`}
                </button>
              ))}
            </div>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="text-[10px] font-bold text-slate-500 uppercase tracking-widest border-b border-slate-800">
                        ...
                        <th className="pb-4 text-right">Total Gold</th>
                        <th className="pb-4 text-right">Efficiency</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-800">
                      {data?.player_stats?.map((p: any) => (
                        <tr key={p.player_id} className="group hover:bg-slate-900/50 transition-colors">
                          <td className="py-4 font-bold text-sm">Player {p.player_id}</td>
